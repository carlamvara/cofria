export const COUNTRIES = [
  ...
  { code: 'AR', name: 'Argentina', currency: 'ARS', symbol: '$', rate: 850, pppFactor: 0.35, dialCode: '+54' },
  ...
  { code: 'CO', name: 'Colombia', currency: 'COP', symbol: '$', rate: 3900, pppFactor: 0.45, dialCode: '+57' },
  ...
  { code: 'MX', name: 'Mexico', currency: 'MXN', symbol: '$', rate: 17, pppFactor: 0.55, dialCode: '+52' },
  ...
  { code: 'PH', name: 'Philippines', currency: 'PHP', symbol: '₱', rate: 56, pppFactor: 0.3, dialCode: '+63' },
  ...
  { code: 'ES', name: 'Spain', currency: 'EUR', symbol: '€', rate: 0.92, pppFactor: 0.8, dialCode: '+34' },
  ...
  { code: 'US', name: 'United States', currency: 'USD', symbol: '$', rate: 1, pppFactor: 1, dialCode: '+1' },
